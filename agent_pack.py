...
class Pack:
    ...
    def jaccard_similarity(self, res=None):
        ...
        # Step 1: Shingling
        str_a = self.current_res['agent_cot']
        str_b = self.current_res['agent_corpus']
        str_c = self.current_res["agent_quant"]
        ...
        combos = list(combinations(shingles, 3))
